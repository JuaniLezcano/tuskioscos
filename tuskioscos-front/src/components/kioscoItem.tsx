  ...
  return (
    <div className="border rounded-lg p-6 mb-6 shadow-lg w-full max-w-4xl mx-auto hover:bg-gray-100 transition duration-300 ease-in-out cursor-pointer" onClick={toggleOpen}>
      <div className="flex justify-between items-center" >
        <span className="text-2xl font-medium ">{kiosco.name}</span>
      ...
      {isOpen && (
        <div className="flex justify-end gap-4 mt-4">
          <Link
            ...
            className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition text-xl"
          ...
          <Link
            ...
            className="bg-gray-800 text-white px-6 py-2 rounded-lg hover:bg-gray-950 transition text-xl"
            onClick={(e) => e.stopPropagation()}
          >
            Cerrar Caja
          </Link>
